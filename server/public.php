...
# Test: curl --data "session=value1" https://jesuschrist.ru/chapi/public
...
try {
    ...
    $q = $db->prepare("SELECT mtime as stamp, mfrom as from_user, mto as to_user, mtext as message, mcolor as color FROM chatmsgs WHERE (hidden=0) AND ((mprivate=0) OR (mfrom='')) AND mtime > ? ORDER BY mtime");
